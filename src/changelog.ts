 ...
 */
export function detectVersionBump(commits: Commit[]): 'major' | 'minor' | 'patch' | 'none' {
 ...
 */
export function groupCommits(commits: Commit[]): ChangelogSection[] {
 ...
 */
export function generateChangelog(version: string, sections: ChangelogSection[]): string {
